...
title: DICOM JSON
summary: Explains how to configure and use the DICOM JSON data source format in Fanoni Imaging, including structure of the JSON file with study/series/instance metadata, implementation examples, and local deployment instructions.
---

# DICOM JSON

You can launch the Fanoni Imaging with a JSON file which points to a DICOMWeb
server as well as a list of study and series instance UIDs along with metadata.

An example would look like

`https://imaging.fanoni.ai/viewer/dicomjson?url=https://ohif-dicom-json-example.s3.amazonaws.com/LIDC-IDRI-0001.json`
...
json file has been generated by Fanoni Imaging team and stored in an amazon s3 bucket for
...
You can run Fanoni Imaging with a JSON data source against you local datasets (given that
