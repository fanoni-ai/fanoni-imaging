...
title: Theming the Fanoni Imaging
summary: Documentation on customizing the visual appearance of the Fanoni Imaging using Tailwind CSS and white-labeling capabilities, including how to modify the color scheme, add custom layouts via the LayoutTemplateModule, and replace the application logo with custom branding.
---
