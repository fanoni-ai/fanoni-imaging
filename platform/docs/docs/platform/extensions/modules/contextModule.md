...
summary: Documentation for Fanoni Imaging Context Module, which enables component communication via React Context, allowing viewport and panel components to share state and synchronize through a common provider mechanism.
---
# Module: Context
